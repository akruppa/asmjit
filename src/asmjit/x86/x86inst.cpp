...
const X86InstExtendedInfo _x86InstExtendedInfo[] = {
  ...
  { Enc(X86Ret)       , 0 , 0 , 0x00, 0x00, 0, { U                 , U                 , U                 , U                 , U                  }, F(None)|F(Special)|F(Flow)         , U                    },
...
const X86InstInfo _x86InstInfo[] = {
  ...
  INST(kX86InstIdRet              , "ret"              , O_000000(C2,U,_,_,_), U                   , Enc(X86Ret)       , F(None)|F(Special)|F(Flow)         , EF(________), 0 , 0 , U                 , U                 , U                 , U                 , U                 ),
